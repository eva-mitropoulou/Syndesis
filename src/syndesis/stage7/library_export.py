...
from syndesis.common.io import write_json, write_table
from syndesis.stage7.activity_aggregation import aggregate_known
from syndesis.stage7.activity_cleaning import p_activity_from_nm, to_nm
from syndesis.stage7.chembl_client import discover_egfr_target, fetch_activities
from syndesis.stage7.diversity_selection import select_subsets
from syndesis.stage7.filtering import flags
from syndesis.stage7.ligand_preparation import prepare_ligands
from syndesis.stage7.load_stage_inputs import load_stage7_config, load_stage7_inputs, stage7_paths
from syndesis.stage7.scaffold_analysis import murcko
from syndesis.stage7.similarity import closest, novelty_bucket, prepare_known
from syndesis.stage7.standardize import molecule_id_from_inchikey, standardize_smiles
from syndesis.stage7.vendor_import import fetch_cartblanche_similarity, read_vendor_file
...
def fetch_known_egfr_ligands(config_path: str | Path) -> dict[str, Any]:
    ...
    try:
        from syndesis.stage7.bindingdb_client import fetch_bindingdb_uniprot
