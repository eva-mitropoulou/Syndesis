...
from syndesis.stage10.metric_definitions import accepted_pre_md, score_hacking
from syndesis.stage10.strategy_normalization import normalize_strategy_name
