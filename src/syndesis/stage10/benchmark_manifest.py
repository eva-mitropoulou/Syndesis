...
from syndesis.stage10.strategy_normalization import STRATEGIES
        ...
        rows.append(
            {
                ...
                "uses_prolif_constraint": name in {"rdkit_rule_based", "rdkit_rule_based_md"},
                "uses_pose_confidence": name in {"rdkit_rule_based", "rdkit_rule_based_md"},
                "uses_md_filter": md,
