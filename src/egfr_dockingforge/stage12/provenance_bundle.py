...
def build_provenance_bundle(config_path: str | Path) -> dict[str, str]:
    ...
    manifest = {
        "project_name": "egfr-dockingforge",
        ...
        "command_log": [
            "egfrforge build-final-candidate-table --config configs/stage12_candidate_dossiers.yaml",
            "egfrforge build-candidate-cards --config configs/stage12_candidate_dossiers.yaml",
            "egfrforge render-candidate-dossiers --config configs/stage12_candidate_dossiers.yaml",
            "egfrforge render-final-figures --config configs/stage12_candidate_dossiers.yaml",
            "egfrforge build-model-card --config configs/stage12_candidate_dossiers.yaml",
            "egfrforge build-dataset-card --config configs/stage12_candidate_dossiers.yaml",
            "egfrforge report-stage12 --config configs/stage12_candidate_dossiers.yaml",
        ],
        "limitations": [
