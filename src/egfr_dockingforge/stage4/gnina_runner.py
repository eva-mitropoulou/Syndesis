...
from egfr_dockingforge.common.io import ensure_dir, project_root, write_table
from egfr_dockingforge.stage4.score_parser import parse_gnina_output
from egfr_dockingforge.stage4.scoring_engines import check_gnina
from egfr_dockingforge.stage4.schemas import GNINA_SCORE_COLUMNS, RAW_GNINA_COLUMNS
...
def _docker_gnina_engine(gnina_cfg: dict[str, Any]):
    ...
    from egfr_dockingforge.stage4.scoring_engines import EngineInfo, parse_gnina_version
