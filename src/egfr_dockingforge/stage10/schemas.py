...
TABLE_SCHEMAS = {
    "ablation_strategy_manifest": [
        "strategy_id","strategy_name","strategy_family","uses_llm","uses_council","uses_tool_feedback","uses_rdkit_validation","uses_docking_score","uses_gnina","uses_prolif_constraint","uses_pose_confidence","uses_md_filter","uses_medchem_filter","generation_budget","screening_budget","llm_model_name","seed_set_id","num_seed_scaffolds","num_iterations","enabled_flag","md_status","notes",
    ],
    "strategy_budget_audit": [
        "strategy_id","seed_id","num_raw_proposals","num_valid_unique_analogs","num_screened_analogs","num_docking_tasks","num_gnina_tasks","num_prolif_tasks","num_pose_confidence_predictions","num_md_tasks_if_available","llm_token_count","walltime_seconds","gpu_seconds","cpu_seconds","budget_normalized_flag","budget_violation_reason",
    ],
    ...
    "compute_cost_metrics": ["strategy_id","cpu_seconds_total","gpu_seconds_total","walltime_seconds_total","num_docking_tasks","num_gnina_tasks","num_prolif_tasks","num_md_tasks_if_available","llm_token_count_total","local_llm_runtime_seconds","accepted_analogs_per_gpu_hour","accepted_analogs_per_wall_hour","accepted_analogs_per_1000_llm_tokens","notes"],
}
