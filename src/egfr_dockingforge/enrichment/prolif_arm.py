...
def _score_one_pose(args: tuple) -> dict[str, Any]:
    ...
    try:
        from egfr_dockingforge.stage5.prolif_engine import fingerprint_from_interactions, tanimoto
...
def add_interaction_arm(
    ...
    *,
    ...
    from egfr_dockingforge.stage5.prolif_engine import prepare_protein_for_prolif
