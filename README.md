...
> Mitropoulou E, Giannopoulos D. **Syndesis v1.1.9-paper: pose-coupled native-interaction weighting for kinase ensemble docking.** GitHub tagged repository snapshot, 2026.
